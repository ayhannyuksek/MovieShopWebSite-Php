         ...
         <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
               <ul class="nav navbar-nav">
                  ...
                  <li class="menu-item-has-children dropdown">
                     <a href="product.php" > Product Manager</a>
                  </li>
				  <li class="menu-item-has-children dropdown">
                     <a href="adminUser.php" > Admin Manager</a>
                  </li>
               </ul>
            </div>
         </nav>
            ...
            <div class="top-right">
               <div class="header-menu">
                  <div class="user-area dropdown float-right">
                     <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo '<strong> Welcome '.$_SESSION["ADMIN_USERNAME"]?></a>
